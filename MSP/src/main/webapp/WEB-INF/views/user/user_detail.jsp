...
<body>
	...
	<div class="modalL_main_div">
				...
				<table class="table">
					<tbody id="tbody1">
						...
						<tr>
							...
							<td style="width: 25%;">
								...
								<input type="hidden" id="active_flg" value="${active_flg}">
 								<input type="text" name="user_id" id="user_id" class="form-control" style=" width:100%" value="${user_id}" onkeypress="fn_press_han(this);" onkeydown="fn_press_han(this);" style="ime-mode:disabled;"/><input type="text" name="emp_no" id="emp_no" class="form-control" style=" width:100%" value="${emp_no}"/>
 							</td>
						...
						<tr>
							...
							<td>
								<input type="password" name="user_pwd" id="user_pwd" class="pwdInput" maxlength="20" style="width:45%" value="${user_pwd}"></input>
							</td>
						...
						<tr>	
							...
							<td colspan="2" align="left">
								<input type="text" name="user_nm" id="user_nm" class="form-control" maxlength="10" style="width:90%" value="${user_nm}"></input>
							</td>
						</tr>
						<tr>
							<th style="padding-left: 1%; text-align: right;"  >휴대 전화</th>
							<td colspan="3" align="left">
								<select name="cphone_num1" id="cphone_num1" class="form-control"  style="width:15%;  float: left;">
						...
						<tr>
							...
							<td colspan="3" align="left">
								<input type="text" name="email_id" id="email_id" class="form-control"  style="width:30%;  float: left; margin-right: 1%;" maxlength="20" value="${email_id}" onkeypress="fn_press_han(this);" onkeydown="fn_press_han(this);" style="ime-mode:disabled;"><input type="text" name="email_domain" id="email_domain" class="form-control"  style="width:35%;  float: left;" maxlength="20"  value="${email_domain}" onkeypress="fn_press_han(this);" onkeydown="fn_press_han(this);" style="ime-mode:disabled;"> 
 							</td>
 						</tr>
						<tr>
		...
		<div class="modalL_btn_div" style="margin-top: 2%;">
			...
			<!-- <input type="button" id="addsave_btn" class="btn btn-primary btn-sm" value="저장"/> -->
