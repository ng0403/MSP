...
public class MenuVO {
	...
	public String toString() {
		return "MenuVO [menu_cd=" + menu_cd + ", menu_nm=" + menu_nm + ", menu_url=" + menu_url + ", menu_level="
				+ menu_level + ", up_menu_cd=" + up_menu_cd + ", active_flg=" + active_flg + ", up_menu_nm="
				+ up_menu_nm + ", active_key=" + active_key + ", menu_nm_key=" + menu_nm_key + "]";
	}
